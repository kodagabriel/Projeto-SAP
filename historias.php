...
<head>
  ...
  <title>Histórias - Projeto SAP</title>
		...
		<div class="row  align-items-center justify-content-center text-center">
			<div class="col-xs-12 col-lg-10 align-self-end">
				<h3 class="text-uppercase font-weight-bold m-5 ">
					Histórias<hr class="divider">
				</h3>
			</div>
		</div>
		<div class="row"> 
			<div class="col-10 mx-auto text-justify">
				<p> Durante o desenvolvimento do Projeto SAP, sentimos a necessidade de disponibilizar neste site a história das mulheres negras que foram pesquisadas para os jogos. A partir disso, decidimos disponibilizar também histórias de outros grupos, como as mulheres na ciência e mulheres no entretenimento (independente de raça) e pessoas da comunidade lgbtq+ (independente de gênero e raça).  </p>
				<p>Importante ressaltar que todas as pessoas aqui foram pesquisadas pelos membros do projeto e uma pessoa pode aparecer em mais de um grupo. Se você encontrou algum informação incorreta ou acha que tem alguém faltando, entre em contato conosco! </p>
			</div>
			<section id="team" class="my-1 text-center">
				<div class="container  container-historias">
					<div class="row justify-content-center">
						<div class="col-6 col-md-4 col-lg-2 cards-historias" id="card1" onclick="esconderDiv(1)" >
							<div class="row">
								<div class="col-12  " >
									<a  href="#dummy"><img src="img/historias/mulheresCiencia.jpg" class="img-fluid img-historias"></a>
								</div>
							</div>
							<div class="row align-bottom">
								<div class="col-12 my-2">
									<h5>Mulheres na Ciência</h4> 
								</div> 
							</div>
							
						</div>

						<div class="col-6 col-md-4 col-lg-2 cards-historias" id="card1" onclick="esconderDiv(2)">
							<div class="row">
								<div class="col-12 ">
									<a  href="#dummy"><img src="img/historias/mulheresEntretenimento.jpg" class="img-fluid img-historias"></a>
								</div>
							</div>
							<div class="row align-bottom">
								<div class="col-12 my-2">
									<h5>Mulheres no Entretenimento</h4> 
								</div> 
							</div>
							
						</div>

						<div class="col-6 col-md-4 col-lg-2 cards-historias" id="card1" onclick="esconderDiv(3)">
							<div class="row">
								<div class="col-12 ">
									<a  href="#dummy"><img src="img/historias/mulheresNegras.jpg" class="img-fluid img-historias"></a>
								</div>
							</div>
							<div class="row align-bottom">
								<div class="col-12 my-2">
									<h5>Mulheres Negras na História</h4> 
								</div> 
							</div>
							
						</div>

						<div class="col-6 col-md-4 col-lg-2 cards-historias" id="card1" onclick="esconderDiv(4)">
							<div class="row">
								<div class="col-12 ">
									<a  href="#dummy"><img src="img/historias/lgbtq+.jpg" class="img-fluid img-historias"></a>
								</div>
							</div>
							<div class="row align-bottom">
								<div class="col-12 my-2">
									<h5>Comunidade LGBTQ+</h4> 
								</div> 
							</div>
...
<section id="exibir-mulheres" style="display: none; padding-top: 65px">
	...
	<div class="container" id="exibir-cards">
		<div class="row">
			<div class="col-12 text-center">
				<div class="dropdown">
					<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" id="dropdown-mulheres" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width: 80%; ">Selecione uma biografia
	...
	<div class="container my-3 d-flex">
		<div class="row h-100 card-mulheres">
			<div class="col-12 col-md-4 text-right align-middle align-self-center  ">
				<img id="imagem-mulheres"src="img\historias\mulheresCiencia\1.jpg" style="width: 100%;">
			</div>
			<div class="col-12 col-md-8">
				<h2 id="nome-mulher" class="degrade text-left"></h2>
				<p id="nacionalidade"><strong>Nacionalidade: </strong> Inglesa(1815 - 1852)</p>
				<p id="formacao"><strong>Formação Acadêmica:</strong> Matemática</p>
				<p id="profissao"><strong>Profissão:</strong> Matemática e escritora inglesa</p>
				<p id="feitos"><strong>Feitos:</strong> escreveu o primeiro algoritmo processado por uma máquina, a máquina analítica de Charles
                Babbage. Desenvolveu os algoritmos que permitiriam à máquina computar os valores de funções matemáticas,
                publicou uma coleção de notas sobre a máquina analítica. É considerada a
                primeira programadora de toda a história.<br><br>
                <i> “Imaginação é a Faculdade da Descoberta. É o que penetra nos mundos invisíveis em torno
                    de nós, os mundos da Ciência”</i>, escreveria ela, em 1841.</p>
			</div>
		</div>
	</div>
	<div class="align-items-center">
			<div class="col-12 text-center">
				<a href="#exibir-mulheres" onclick="trocamulher(-1)">Anterior</a> &nbsp &nbsp &nbsp &nbsp &nbsp

				&nbsp &nbsp &nbsp &nbsp &nbsp <a href="#exibir-mulheres" onclick="trocamulher(1)">Próximo</a>
			</div>
	</div>
