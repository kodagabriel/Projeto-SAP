...
<fieldset>
	...
	<ol>
		...
		<li> <?php _e( 'Preferred Contact Method', CF7SKINS_TEXTDOMAIN ); ?> [radio cf7s-radio1 default:1 "<?php _e( 'Email', CF7SKINS_TEXTDOMAIN ); ?>" "<?php _e( 'Phone', CF7SKINS_TEXTDOMAIN ); ?>"] </li>
