...
<fieldset>
	...
	<ol>
		...
		<li> <?php _e( 'Radio buttons', CF7SKINS_TEXTDOMAIN); ?> [radio cf7s-radio1 default:1 "<?php _e( 'Option 1', CF7SKINS_TEXTDOMAIN ); ?>" "<?php _e( 'Option 2', CF7SKINS_TEXTDOMAIN ); ?>" "<?php _e( 'Option 3', CF7SKINS_TEXTDOMAIN ); ?>"] </li>
