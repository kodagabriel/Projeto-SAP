...
<fieldset>
	...
	<ol>
		...
		<li> <?php _e( 'Are you an existing customer?', CF7SKINS_TEXTDOMAIN ); ?> [radio cf7s-radio1 default:1 "<?php _e( 'Yes', CF7SKINS_TEXTDOMAIN ); ?>" "<?php _e( 'No', CF7SKINS_TEXTDOMAIN ); ?>"] </li>
